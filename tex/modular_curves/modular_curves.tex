...
Let $S$ be a variety over a field $K$, and let $a_1,a_2,a_3,a_4,a_6 \in \Gamma(S,\mathcal O_S)$ be regular functions such that for all $s \in S(\overline K)$ one has $\Delta_{a_1,a_2,a_3,a_4,a_6}(s) \neq 0$ (or equivalently $\Delta_{a_1,a_2,a_3,a_4,a_6} \in \Gamma(S,\mathcal O_S)^*$ ) \todo{define $\Delta$}. Then the Weierstrass-Model with invariants $a_1,a_2,a_3,a_4,a_6$ is defined to be the triple $(E_{a_1,a_2,a_3,a_4,a_6},f,0)$ over $S$ where, \begin{itemize}[label=-]
